...
<head>
    ...
    <title>Dashboard — President Verifier — IMRMS</title>
...
<main class="main-content gsd-main">
    <div class="page-header">
        <div class="gsd-kicker"><i class="fas fa-stamp"></i> President verifier workspace</div>
        <h1>Dashboard</h1>
        <p>Welcome back, <?php echo htmlspecialchars($username); ?>! Overview for presidential verification (UI only — connect API for live metrics).</p>
    </div>

    <?php require __DIR__ . '/partials/dashboard_overview_charts.php'; ?>

    <div class="dashboard-grid">
        <div class="dashboard-card" data-notification-key="president_pending">
            ...
            <div class="card-footer">
                ...
                <span>Awaiting president action</span>
            </div>
        </div>
