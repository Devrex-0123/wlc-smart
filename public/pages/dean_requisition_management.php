...
<aside class="sidebar" id="sidebar">
    ...
    <nav>
        <ul class="sidebar-nav">
            ...
            <li><a href="dean_requisition_management.php" class="active" data-notification-view-key="inventory_review"><i class="fas fa-file-signature"></i> <span>Requisition Management</span></a></li>
