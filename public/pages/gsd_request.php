...
<main class="main-content">
    <div class="page-header management-header">
        <div>
            ...
            <p>View requisition lines across all offices (read-only). Use <strong>View</strong> to open the requester&rsquo;s form and verify or reject at GSD.</p>
        </div>
    </div>
    ...
    <div class="summary-grid">
        <div class="summary-card">
            <p>Total Requests</p>
            <h3 id="gsdTotalCount">0</h3>
        </div>
        <div class="summary-card">
            <p>Pending</p>
            <h3 id="gsdPendingCount">0</h3>
        </div>
        <div class="summary-card">
            <p>Ongoing</p>
            <h3 id="gsdOngoingCount">0</h3>
        </div>
        <div class="summary-card">
            <p>Completed</p>
            <h3 id="gsdCompletedCount">0</h3>
        </div>
    </div>
    ...
    <div class="filter-section">
        ...
        <div class="filter-controls">
            <div class="search-container">
                ...
                <input type="text" id="gsdReqSearch" class="search-input" placeholder="Search request, requester, office, or item…">
            </div>
            <select id="gsdReqStatus" class="sort-dropdown">
                <option value="all">All Status</option>
                <option value="Pending">Pending</option>
                <option value="Ongoing">Ongoing</option>
                <option value="Completed">Completed</option>
            </select>
            <select id="gsdReqSort" class="sort-dropdown">
    ...
    <div class="table-container">
        ...
        <div class="pagination-controls">
            <button type="button" id="gsdPrevReqBtn" class="pagination-btn" disabled>
                <i class="fas fa-chevron-left"></i> Previous
            </button>
            <span id="gsdReqPageInfo" class="page-info">Page 1</span>
            <button type="button" id="gsdNextReqBtn" class="pagination-btn" disabled>
...
<script src="../assets/js/gsd_requests.js"></script>
</body>
</html>
