...
(function () {
    ...
    const statusFilter = document.getElementById('compReqStatus');
    const sortDropdown = document.getElementById('compReqSort');
    const totalCount = document.getElementById('compTotalCount');
    const pendingCount = document.getElementById('compPendingCount');
    const ongoingCount = document.getElementById('compOngoingCount');
    const completedCount = document.getElementById('compCompletedCount');
    const prevReqBtn = document.getElementById('compPrevReqBtn');
    const nextReqBtn = document.getElementById('compNextReqBtn');
    const reqPageInfo = document.getElementById('compReqPageInfo');
